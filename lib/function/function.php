<?php 
 ...
 function pro_video_update_view(){
    ...
    //function for account update view for user accounts
    function account_update_view_user(){
        $con = Connection();
     ...
     $account_update_echo .="</tr>
                    ...
                    <a href='edit_account_user.php'><button class='btn btn-primary'>Back</button></a>
                </div>
        ";
    ...
    function update_account($user_update_id, $user_update_username, $user_update_email){
        ...
        $user_check = "SELECT * FROM user_tbl WHERE email='$email'";
        ...
        if($user_check_row['roll'] == 'admin' && $user_check_row['account_type'] == 'pro'){
            header("location:edit_account.php");
        }elseif($user_check_row['roll'] == 'user' && $user_check_row['account_type'] == 'free'){
